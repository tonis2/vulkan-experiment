// This code is taken from https://github.com/zenith391/didot/tree/master/didot-image, thanks zenith391
...
pub const ColorChannel = enum { Red, Green, Blue, Alpha };
...
pub const ImageFormat = struct {
    ...
    pub fn getBitMask(self: *ImageFormat, channel: ColorChannel) u32 {
        return switch (channel) {
            .Red => self.redMask,
            .Green => self.greenMask,
            .Blue => self.blueMask,
            .Alpha => self.alphaMask,
        };
    }
